  ...
  return (
    <main className="container">
      ...
      <p style={{ opacity: 0.8, marginBottom: 24 }}>
        Tweak colors in <code>apps/portal/theme.ts</code>, replace{" "}
        <code>apps/portal/public/brand/logo.svg</code> or <code>hero.jpg</code>,
        and refresh.
      </p>
      ...
      <div className="row" style={{ marginTop: 24 }}>
          ...
          <div className="row">
            {[
              ...
              <div key={k} style={{ textAlign: "center" }}>
                ...
                <div style={{ fontSize: 12, opacity: 0.8, marginTop: 6 }}>{k}</div>
              </div>
            ))}
          </div>
        </Card>
        <Card style={{ flex: 1 }}>
          ...
          <p>Preview headings, body text, cards and lists.</p>
          <ul>
